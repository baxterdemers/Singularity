...
public class AgentResource extends AbstractMachineResource<SingularitySlave> {
  ...
  public List<SingularitySlave> getAgents(
  ...
  public Optional<SingularitySlave> getAgent(
    @Parameter(hidden = true) @Auth SingularityUser user,
    @Parameter(required = true, description = "Agent ID") @PathParam(
      "agentId"
    ) String agentId
